export const GRAMMARS = [
  { id: 'slavic-modern', short: 'SLA', name: 'Slavic Modern', desc: 'grounded heirloom warmth; ritual table presence without folk literalism', base: { height: 80, base: 78, rim: 102, belly: .64, waist: .28, foot: .76, lip: .38, shoulder: .48, quiet: .66, handle: .58 } },
  { id: 'viking-nordic-modern', short: 'NOR', name: 'Viking / Nordic Modern', desc: 'low gravity, broad stability, northern restraint', base: { height: 76, base: 84, rim: 98, belly: .42, waist: .14, foot: .62, lip: .24, shoulder: .32, quiet: .86, handle: .42 } },
  { id: 'japan-modern', short: 'JPN', name: 'Japan Modern', desc: 'quiet low bowl-cup, precise foot, controlled rim', base: { height: 72, base: 74, rim: 104, belly: .28, waist: .08, foot: .46, lip: .20, shoulder: .18, quiet: .94, handle: .34 } },
  { id: 'classic-modern', short: 'CLA', name: 'Classic Modern', desc: 'balanced table cup, familiar but not generic', base: { height: 82, base: 76, rim: 102, belly: .44, waist: .26, foot: .54, lip: .34, shoulder: .36, quiet: .72, handle: .50 } },
  { id: 'french-modern', short: 'FRA', name: 'French Modern', desc: 'restrained salon tulip, lifted rim, elegant tension', base: { height: 84, base: 72, rim: 108, belly: .36, waist: .46, foot: .52, lip: .62, shoulder: .56, quiet: .52, handle: .64 } },
  { id: 'italian-modern', short: 'ITA', name: 'Italian Modern', desc: 'cafe warmth, cappuccino softness, generous but controlled rim', base: { height: 78, base: 76, rim: 110, belly: .62, waist: .30, foot: .46, lip: .54, shoulder: .62, quiet: .54, handle: .62 } }
];
